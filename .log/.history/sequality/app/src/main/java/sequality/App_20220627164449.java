...
public class App {
  ...
  public static void main(String[] args) {
    ...
    System.out
        .println("Sum of odd of 1 to is" + calculate.sum3(1, 10) + "." + calculate.sum3(calculate.sum4(1, 10)));

    System.out
        .println("Sum of even of 1 to is" + calculate.sum3(1, 10) + "." + calculate.sum4(calculate.sum4(1, 10)));
  }
}
